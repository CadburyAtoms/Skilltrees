...
## 2026-09-06 — Item 19b: the dated deltas MOVED to `docs/handoff-changelog/2026-MM.md`; the handoff is the reference alone (**DOCS-ONLY** + TOOLING for the one script; TODO_REPO_HYGIENE #19, half b; PR #TBD)
