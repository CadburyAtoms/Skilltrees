...
## 182. [x] Migration PR 1 — per-type field sets in the native-vocabulary snapshot, so lint pass 11 can see an Embedded-Actions break at all (TOOLING; nothing to deploy) (2026-09-15, PR #TBD)
