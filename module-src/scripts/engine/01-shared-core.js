...
const EDHA_STATUSES = {
  ...
  frightened: { label: "Frightened", icon: "icons/svg/terror.svg", condition: true, _id: "condfrightened00" },   // Power (Tyrith) — GM-applied marker; no talent reads it now (R-125 (a), 2026-09-13: Kneel's advantage passive + Absolute Authority's gate moved to Disoriented — item 135)
