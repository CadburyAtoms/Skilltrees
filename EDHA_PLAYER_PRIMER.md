# Thyrcross — A Player's Primer

**Player-safe character-creation handout.** Everything below is common knowledge a person of
Thyrcross would grow up with — safe to read aloud, print, or hand out whole.

> **GM note (the only GM text in this file):** spoiler-checked against the session-1
> do-NOT-reveal wall (`EDHA_SESSION_1_SCRIPT.md` §0). The crisis *statuses* are public; their
> *causes* are not, and the specific wrongness session 1 exists to reveal is deliberately
> absent. A PC from a deep-plague nation (Malcurr, Corvaine) plausibly knows more than this
> sheet says — brief that player privately rather than expanding the handout. Full GM culture
> blocks: canon doc §5b.

---

## The world in ten breaths

Thyrcross is one continent, ten nations, about 4,000 km top to bottom — glacier coast in the
north, mesa badlands and singing plains in the south. Five **leylines** — White, Blue, Black,
Red, Green — run through everything, everywhere; some places they run strong enough to see, and
people who learn to draw on them work what everyone calls magic. Ten **gods** are real. They
have churches, they answer prayers — some of them, some of the time — and they are far away in
...
Ask why and you'll get a shrug: it's just what's done.

## The ten gods (as everyone knows them)

Worship is organized and local — most nations keep one established church, or none. All ten are
real; which ones *answer* is a matter your priest gets quiet about.

| God | Domain | Called | Where the faith is strongest |
|---|---|---|---|
| Verdannis | Sovereignty | the Crowned Arbiter | Thalendor |
| Maelith | Chaos | the Unmaker of Certainties | Kettavar |
| Tessavain | Order | the Lawgiver | church networks everywhere; no home nation |
| Anaveth | Life | the Vital Hand | healers' orders, scattered |
| Morrath | Death | the Last Harvest | village shrines everywhere — every town has one |
| Gnothis | Knowledge | the Watching Mind | Malcurr; the "old ways" on the borders |
| Olvarra | Fate | the Thread-Reader | small, quiet fellowships |
| Kethane | Civilization | the Great Builder | soldiers, builders, and roadwrights everywhere |
| Tyrith | Power | the Iron Crown | ambitious courts and companies, discreetly |
| Razkael | Destruction | the Sundering Flame | nowhere for ~120 years — a curse word in Vorsk |

## The five leylines (if your character touches magic)

All five are everywhere; places and people differ in what runs strong in them. As a rough
palette: **White** — coordination, bulwark, accord. **Blue** — calculation, illusion,
foresight. **Black** — entropy, isolation, dominion. **Red** — heat, ferocity, the surge.
...
generations of calm, and a religion of *managed* chaos: omens cast before every undertaking,
...
The mage-ruled utopia in the continent's green heart, where the famous Root Network runs —
and the nation the famine has hit worst, devout as it is. The Mage's alchemical vats keep
everyone fed on pale "bread" that fools nobody, served in proud courses it's rude to name
...
border; a station-sworn miller with no grain, asking the Lowered Crown question out loud.

### Goldenport — the west coast

The guild oligarchy of the deep inlets — and, embarrassingly, the place the hard years forgot.
Gardens overgrow their plots, wounds knit clean, fevers pass mild; locals call it *the Port's
luck*, knock wood, and tithe the poor-box so the Luck doesn't notice them. No church — the
...
unwritten debtor working passage; a dockside healer whose hands work better than they should.

### Vorsk — the northwest mountains

High valleys, thin soil, long winters — and the warlord state everyone else calls bandit
country, wrongly. Raiding here is subsistence with *laws*: take in shares, never the seed
grain, never the tools of a trade, never the last of anything; burning what you can't carry is
...
The fae nation, at peace, and mostly a closed door. Trade happens at the Strand, the one
permitted port; inland the roads simply don't cooperate with visitors. What traders learn:
the fae keep *exact* reciprocity — every gift returned in kind and measure — guard their names,
and sell wonders (dyes, instruments, seedstock) that never quite propagate elsewhere. Exile
from Sylvaneth is nearly unheard of, and absolute: the exiled are escorted out, provided for,
and never named again.
**Names:** guarded single use-names + earned epithets (*Ashara the Unbroken* — a name traders
notice Sylvaneth partners will not say).
**You might be:** a Strand-side trader fluent in fae courtesy; a mortal raised near the island
...
Verdannis reads truest in Thalendor; Maelith in Kettavar; Gnothis in Malcurr or as the
borderers' "old ways"; Kethane among soldiers and builders anywhere; Tessavain through the
law-church network anywhere; Anaveth through healers' orders; Morrath at every village shrine
