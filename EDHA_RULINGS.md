...
### G.1 — The bestiary redo's menu (filed 2026-09-14 by the session that scoped item 121; all WAITING)

*Eight decisions the redo needs before any block changes. Each carries a recommended default; the facts are read from `docs/analysis/bestiary/CENSUS.md` (the measured census of the 52 blocks) and the standard is `.claude/skills/bestiary-forge/STANDARD.md`, whose PENDING lines these answer. Ben, 2026-09-14, on the plan that produced them: "This looks good. Continue."*
...
## L. Waiting — R-127 (bench run 47); the six design proposals below are all answered and moved (2026-09-14)
