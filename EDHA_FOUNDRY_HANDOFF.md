...
- [x] **1. Heroic talent copy-in — DONE 2026-07-18f (data + build → pack rebuild + ⟳ Sync).**
  ...
  edha-events over time, test-pass style): Animal Bond, Baleful, Bloodstance, Clear Mind,
