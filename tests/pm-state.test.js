...
test("build-dashboard: parseOpenRulings finds the 17 ecosystem-review rulings open in the real EDHA_RULINGS.md", () => {
  ...
  const ECOSYSTEM_RULINGS = ["R-120", "R-121", "R-122", "R-123", "R-124", "R-125", "R-114", "R-115", "R-116", "R-117", "R-118", "R-119", "R-92"]; // R-92 relocated from §K to §L on 2026-09-13 (it was open all along)
